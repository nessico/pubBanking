...
public class CustomInstantDeserializer<T extends Temporal>
    ...
    public static final CustomInstantDeserializer<LocalDate> LOCAL_DATE = new CustomInstantDeserializer<>(
            ...
            a -> OffsetDateTime.ofInstant(Instant.ofEpochSecond(a.integer, a.fraction), a.zoneId).toLocalDate(),
            (d, z) -> OffsetDateTime.from(d).withOffsetSameInstant(z.getRules().getOffset(OffsetDateTime.from(d).toLocalDateTime())).toLocalDate()
    );
